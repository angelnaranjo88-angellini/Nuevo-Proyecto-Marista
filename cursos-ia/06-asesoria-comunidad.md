# 06 · Asesoría de un mes y comunidad

> Este es el documento más importante de todos. El mes de asesoría es tu mejor
> argumento de venta **y** tu mayor riesgo operativo. Si lo dejas indefinido,
> te come. Diseñado así, escala.

## 1. Qué incluye exactamente (esto va publicado, textual)

**Durante los 30 días siguientes a tu última sesión tienes:**
...
| Componente | Costo para ti | Valor percibido | Función |
|---|---|---|---|
| Grupo de WhatsApp | ~20 min/día para todos los grupos | Alto: "me contesta" | Sensación de acompañamiento |
| Consultorio grupal | **1 h/semana en total, sin importar cuántos alumnos** | Alto: es en vivo | El componente que escala |
| 1 a 1 de 30 min | 30 min × alumno, una vez | **Altísimo** | El que se menciona en los testimonios |
| Biblioteca | Se hace una vez | Medio | Retención hacia la membresía |
...
## 3. Las reglas (publícalas, no las improvises)

Estas van en el documento de bienvenida y evitan el 90% de los problemas:

1. **El grupo es para dudas del curso.** No es soporte técnico general ni un
   canal para que te hagan el trabajo.
...
5. **"Hazme mi trabajo" no es una duda.** Si alguien quiere que le construyas su
   automatización, eso es Mentoría 1 a 1 y tiene precio.
...
Con clases (≈10 h) y marketing/administración (≈4 h), llegas a **23 h/semana**,
consistente con tu disponibilidad. Si crece más, la primera palanca es **agrupar
...
- **0–5 min:** bienvenida, quién es nuevo, qué se logró esta semana (una victoria
  de alguien, en voz alta — esto es lo que engancha)
- **5–40 min:** dudas en pantalla compartida, por orden de llegada. Se resuelve
  **haciéndolo**, no explicándolo
- **40–55 min:** un tema breve nuevo cada semana (algo que salió, una herramienta
  nueva, un truco). Rota y da razón para volver
- **55–60 min:** cierre, recordatorio de qué viene, invitación a traer dudas
...
- Un Laboratorio presencial al mes
- 20% de descuento permanente en cursos nuevos y talleres
- Acceso anticipado a lo que lances

**Por qué importa tanto:** es el único ingreso que no depende de que vendas un
curso ese mes. Con 200 egresados al año y 30% de retención son **$17,400 MXN
mensuales recurrentes** por una hora de trabajo a la semana que ya estás
haciendo de todos modos.

**Cómo se ofrece, sin ser incómodo:** en la última semana del mes incluido, un
...
Sin presión, sin cargo automático, con salida fácil. Convierte mejor y no te
quema la reputación.
